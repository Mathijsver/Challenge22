...
function setTimeVars(){
  ...
  if (ss.length==1) ss = "0"+ss; //wanneer het aantal minuten maar uit 1 bestaat, voeg dan een extra 0 toe
  if (mm.length==1) mm = "0"+mm;
  if (hh.length==1) hh = "0"+hh;
    
   	if (t.getHours > 19 || t.getHours < 6)
	  // Als de tijd na 19.00 is of voor 6.00, nacht thema to ‘body’
	  document.body.className = "night";
	else if (t.getHours > 16 && t.getHours < 19)
	  // als de tijd tussen 16.00 en 19.00 is gebruik sunset
